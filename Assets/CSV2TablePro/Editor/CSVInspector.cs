    ...
    public class CSVInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (metaData.isStatic)
            {
                ...
                metaData.staticCsvPath = path.Replace(".csv", "");
            }

            // Is using nameType?
            metaData.isNameType = EditorGUILayout.Toggle("Is nametype?", metaData.isNameType);
            ...
            if (foldout)
            {
                ...
                for (int i = 0; i < metaData.columns.Count; i++)
                {
                    ...
                    int newTypeIndex = EditorGUILayout.Popup(typeIndex, CSVMetaData.ColumnType, GUILayout.MaxWidth(100));
